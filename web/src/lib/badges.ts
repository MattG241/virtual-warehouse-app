...
export const BADGES: Record<BadgeKey, BadgeMeta> = {
  'daily-mvp': {
    ...
    imageUrl: '/badges/daily-mvp.png?v=2',
    tier: 'gold',
  },
  marathon: {
    key: 'marathon',
    ...
    imageUrl: '/badges/marathon.png?v=2',
    tier: 'gold',
  },
  'half-k': {
    key: 'half-k',
    ...
    imageUrl: '/badges/half-k.png?v=2',
    tier: 'silver',
  },
  'pack-pro': {
    key: 'pack-pro',
    ...
    imageUrl: '/badges/pack-pro.png?v=2',
    tier: 'silver',
  },
  century: {
    key: 'century',
    ...
    imageUrl: '/badges/century.png?v=2',
    tier: 'bronze',
  },
  'clean-run': {
    key: 'clean-run',
    ...
    imageUrl: '/badges/clean-run.png?v=2',
    tier: 'bronze',
  },
}
